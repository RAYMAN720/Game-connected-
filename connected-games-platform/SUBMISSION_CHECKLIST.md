...
- [x] Quattro ruoli: giocatore, admin locale, admin gioco, admin piattaforma
- [x] Tipi di gioco, regole e modelli sensore
...
- [x] Database accessibile solo dai servizi centrali
- [x] Interfacce web per tutti i ruoli e interfaccia edge locale
