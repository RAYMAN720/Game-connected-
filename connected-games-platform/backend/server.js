...
app.use('/api/auth',require('./routes/authRoutes'));app.use('/api/locales',require('./routes/localeRoutes'));app.use('/api/games',require('./routes/gameRoutes'));app.use('/api/users',require('./routes/userRoutes'));app.use('/api/game-types',require('./routes/gameTypeRoutes'));app.use('/api',require('./routes/deviceRoutes'));app.use('/api/matches',require('./routes/matchRoutes'));app.use('/api/tournaments',require('./routes/tournamentRoutes'));app.use('/api/teams',require('./routes/teamRoutes'));app.use('/api/statistics',require('./routes/statsRoutes'));
