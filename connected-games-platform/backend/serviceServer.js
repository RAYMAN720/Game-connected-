...
const matchRoutes=require('./routes/matchRoutes');const tournamentRoutes=require('./routes/tournamentRoutes');const teamRoutes=require('./routes/teamRoutes');const statsRoutes=require('./routes/statsRoutes');
...
if(mode==='catalog'){
  app.use('/api/auth',authRoutes);app.use('/api/locales',localeRoutes);app.use('/api/games',gameRoutes);app.use('/api/users',userRoutes);app.use('/api/game-types',gameTypeRoutes);app.use('/api',deviceRoutes);
